...
Builder.prototype.downloadDependencies = function(callback) {
    ...
    async.series([
        function(callback) { getContentFromURL('https://codeload.github.com/asciidoctor/asciidoctor-stylesheet-factory/zip/master', builder.targetGzStylesFile, callback); }
    ], function() {
        typeof callback === 'function' && callback();
    });
}
